...
<span style="color: gray; font-size: 0.9em;">Last edited: 2026-07-22</span>
...
each firing on its own trigger. So that a contributor without Claude Code is not locked out, each skill
