...
Use the [Interactive Phasing Widget](#widget-phase) to interactively adjust $p_0$ and $p_1$.
:::
...
The dedicated documentation is here: [Automated Phase Correction](#autophase-intro).
:::
